				...
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<tbody id="cart_item_list">
							<form action="{{route('donation.index')}}" method="POST">
								@csrf
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											<td class="product-des" data-title="Description">
												...
												<input type="hidden" name="project_name" value="{{$cart->product['title']}}" />
											</td>
											<td class="qty" data-title="Description">{{$cart['description']}}</td>
									...
									<track>
										...
										<td class="float-right">
											...
											<input type="hidden" name="project_name" value="{{$cart->product['title']}}" />
											<button type="submit" class="btn">DONATE TO THIS PROJECT</button>
										</td>
									</track>
								@else 
										<tr>
