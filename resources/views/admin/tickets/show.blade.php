...
<div class="card" style="margin: auto; width: 80%;">
    ...
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @empty
                                ...
                                <hr />
                            @endforelse
                            <form action="{{ route('ad-min.tickets.storeComment', $ticket->id) }}" method="POST">
                                @csrf
        ...
        <a class="btn btn-default my-2" href="{{ route('ad-min.tickets.index') }}">
            {{ trans('global.back_to_list') }}
        </a>

        <a href="{{ route('ad-min.tickets.edit', $ticket->id) }}" class="btn btn-primary">
