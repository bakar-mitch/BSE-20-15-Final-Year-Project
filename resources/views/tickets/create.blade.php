...
@section('title','Inno Mak || Support Tickets')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- <form class="form" method="POST" action="{{ route('tickets.store') }}"> -->
                        ...
                        <div class="form-group row">
                            <label for="content" class="col-md-4 col-form-label text-md-right">@lang('cruds.ticket.fields.priority')</label>

                            <div class="col-md-6">
                              <select name="priority_id" id="normal_search" class="form-control select2" required>
                        ...
                        <div class="form-group row">
                            <label for="content" class="col-md-4 col-form-label text-md-right">@lang('cruds.ticket.fields.category')</label>

                            <div class="col-md-6">
                              <select  name="category_id" id="normal_search" class="form-control select2" required>
                                <option value="">Select a category</option>
                                  <option value="Technical Assistance">Technical Assistance</option>
                                  <option value="Non-Technical Assistance">Non-Technical Assistance</option>
