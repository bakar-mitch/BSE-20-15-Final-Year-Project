                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                <input name="payment_method"  type="radio" value="cod"> <label> Stripe (Credit/Debit card)</label><br>
                                                <input name="payment_method"  type="radio" value="paypal"> <label> PayPal</label><br> 
                                                <input name="payment_method"  type="radio" value="momo"> <label> MTN Momo</label> 
                                            </form-group>
